...
class AdminConfigManager {
  ...
  constructor() {
    ...
    console.log('✅ AdminConfigManager: Sistema inicializado com sucesso');
  }
  ...
  private loadConfig(): AdminConfig {
    ...
    // Garante que todas as propriedades existam (merge com padrão)
  ...
  /**
   * Configura acesso global às configurações
   */
  private setupGlobalAccess(): void {
    // Disponibiliza globalmente para acesso de qualquer lugar
    ...
    console.log('🌐 AdminConfigManager: Acesso global configurado');
  }
